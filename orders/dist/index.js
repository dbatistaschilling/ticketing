...
const start = async () => {
    ...
    try {
        ...
        new listeners_1.TicketCreatedListener(nats_wrapper_1.natsWrapper.client).listen();
        new listeners_1.TicketUpdatedListener(nats_wrapper_1.natsWrapper.client).listen();
        new listeners_1.ExpirationCompleteListener(nats_wrapper_1.natsWrapper.client).listen();
        new listeners_1.PaymentCreatedListener(nats_wrapper_1.natsWrapper.client).listen();
